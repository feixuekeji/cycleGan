...
parser.add_argument("--save_image_path", type=str, default="/content/drive/MyDrive/images", help="name of the dataset")
parser.add_argument("--save_model_path", type=str, default="/content/drive/MyDrive/saved_models", help="path of saved_models")
